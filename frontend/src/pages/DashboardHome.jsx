...
function DashboardHome() {
  ...
  // Read user from localStorage — same place your auth stores the token
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        >
          <h3 className="text-lg font-semibold text-gray-800">View Nearby Issues</h3>
          <p className="text-sm text-gray-500 mt-1">See issues within 3 km</p>
        </button>
        ...
        <button
          ...
          className="bg-white border rounded-xl p-6 text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-200"
        >
          <h3 className="text-lg font-semibold text-gray-800">Become a Donor</h3>
          <p className="text-sm text-gray-500 mt-1">Register as verified donor</p>
        </button>
        ...
        >
          <h3 className="text-lg font-semibold text-gray-800">Manage My Reports</h3>
          <p className="text-sm text-gray-500 mt-1">Track and update your submissions</p>
        </button>
