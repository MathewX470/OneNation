    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .rf-wrap { width: 100%; max-width: 640px; animation: fadeUp 0.4s ease; }
        ...
        .rf-section-label::after { content: ''; flex: 1; height: 1px; background: #F0F0F0; }

        /* 8-column blood group grid — all 8 in one row on desktop */
        .rf-blood-grid {
          display: grid;
        ...
        /* 3-column urgency grid on desktop */
        .rf-urgency-group {
          display: grid;
        ...
        .rf-urgency-desc { font-size: 0.78rem; color: #888; margin-top: 2px; line-height: 1.4; }
            ...
            <div className="rf-section">
              ...
              <div className="rf-units-wrap">
                <input
                  ...
                  type="number" name="unitsRequired" min="1" placeholder="0"
